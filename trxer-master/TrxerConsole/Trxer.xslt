...
>
  ...
  <msxsl:script language="C#" implements-prefix="trxreport">
    ...
    public string GetBrowserName(string text)
    {
       Match match = Regex.Match(text, "('|\")([^\\s]+(\\.(?i)(Browser Name)))('|\")",
	      RegexOptions.IgnoreCase);
        ...
        <div id="divToRefresh" class="wrapOverall">
            ...
            <table class="SummaryTable">
              ...
              <tbody>
                <xsl:for-each select="/t:TestRun/t:Times">
                  ...
                  <tr class="odd">
                    <th class="column1 statusCount">Browser Details</th>
                    <td class="statusCount">
                      <xsl:value-of select="/t:TestRun/t:Results/t:UnitTestResult/t:Output/t:StdOut" />
                    </td>
                  </tr>
                  <tr>
          ...
          <Table>
            ...
            <tbody>
              ...
              <tr>
                <td colspan="5">
                  <h6>Html Viewer log - SONATA SOFTWARE</h6>
                </td>
              </tr>
            </tbody>
          </Table>
